...
def open_admin_dashboard():
    ...
    try:
        ...
        # TOTAL RESPONSE LABEL
        total_label = tk.Label(admin,
            text=f"TOTAL SURVEY RESPONSES: {total_responses}",
            font=("Helvetica",14,"bold"),
            fg="brown")
        total_label.pack(pady=5)

        # Separator Line
        separator = tk.Frame(admin, height=3, bg="black")
        ...
        ax[0,0].set_title("LEARNING EXPERIENCE RATING", fontsize=12, 
                  fontweight='bold', 
                  color='darkgreen')
        ...
        # Profession Chart
        ax[0,1].pie(prof_counts, labels=prof_labels, autopct='%1.1f%%')
        ax[0,1].set_title("PROFESSION DISTRIBUTION", fontsize=12, fontweight='bold', color='darkgreen')

        # Device Used
        bars2 = ax[1,0].bar(dev_labels, dev_counts)
        ax[1,0].set_title("DEVICE USED FOR ONLINE LEARNING", fontsize=12, fontweight='bold', color='darkgreen')
        ...
        # Learning Time
        ax[1,1].pie(time_counts, labels=time_labels, autopct='%1.1f%%')
        ax[1,1].set_title("LEARNING TIME SPENT DAILY", fontsize=12, fontweight='bold', color='darkgreen')

        # Internet Quality
        bars3 = ax[2,0].bar(net_labels, net_counts)
        ax[2,0].set_title("INTERNET QUALITY DURING ONLINE LEARNING", fontsize=12, fontweight='bold', color='darkgreen')
        ...
        # Learning Mode
        ax[2,1].pie(mode_counts, labels=mode_labels, autopct='%1.1f%%')
        ax[2,1].set_title("LEARNING MODE PREFERENCE", fontsize=12, fontweight='bold', color='darkgreen')
