...
🚀 Features
  ...
  📝 Dynamic Survey Form with multiple inputs
...
Category	Tools Used
  ...
  │
  ├── Database Integration (Tkinter + MySQL).py
  ├── Data Analysis from MySQL.ipynb
  ├── Polling System Cleaned Data.csv
  ├── Polling System Power BI.pbix
  │
  ├── screenshots/
  │   ├── login.png
  │   ├── survey.png
